...
pub use vmotherboard::VmChipsetResult;
...
/// Private extension methods for building the VM chipset result.
trait VmChipsetResultBuilding {
...
impl VmChipsetResultBuilding for VmChipsetResult {
    fn attach_i8042(&mut self) -> &mut Self {
